...
<body>
  ...
  <div class="nav">
    ...
    <br>
       ...
       <div class="container">
       <form action="driverupdation.php" method="post">
          <center>
            <h2>Add Driver</h2>
          </center>
          ...
          <label for="regno"><b>registration number</b></label>
                <input type="text" name="regno" id="mail" placeholder="Enter registration number" required class="form-control">
                <br>
          ...
          <br>
                ...
                <input type="email" name="mail" id="mail" placeholder="Enter Email Address" required class="form-control">
              
              <br>
              
              
             <center> <label for="joined_on"  class=" mx-auto"><b>Date Of Joining</b></label></center>
                <input type="date" name="joined_on" id="joined_on" placeholder="Date Joined On" required class="form-control mx-auto" style="width:35vw;">

  ...
  <div class="nav">
    ...
    <br>
       ...
       <form action="book.php" method="post">
          ...
          <label for="source"><b>Srouce</b></label>
                <input type="text" name="from" id="mail" placeholder="Enter Source" required class="form-control">
                <br>

            <label for="destination"><b>Destination</b></label>
            <input type="text" placeholder="Enter Destination" name="to" required class="form-control">
          <br>
             <center> <label for="ddate"  class=" mx-auto"><b>Departure Date</b></label></center>
                <input type="date" name="ddate" id="joined_on" placeholder="Date Joined On" required class="form-control mx-auto" style="width:35vw;">
